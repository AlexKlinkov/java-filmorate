...
friend_id bigint REFERENCES user_filmorate (id) ON DELETE CASCADE,
user_filmorate_id bigint REFERENCES user_filmorate (id) ON DELETE CASCADE,
status boolean,
...
CREATE TABLE IF NOT EXISTS reviews (
    ...
    user_id int REFERENCES user_filmorate (id),
